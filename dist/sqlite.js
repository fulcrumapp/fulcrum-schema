...
},{"./schema-change":2,"underscore":10}],4:[function(require,module,exports){
...
},{"./schema-change":2,"./schema-generator":5,"underscore":10}],5:[function(require,module,exports){
...
},{"./table":8,"./utils":9,"underscore":10}],7:[function(require,module,exports){
var SchemaGeneratorBase, SqliteSchemaGenerator, _,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;
...
SqliteSchemaGenerator = (function(superClass) {
  extend(SqliteSchemaGenerator, superClass);

  function SqliteSchemaGenerator() {
    return SqliteSchemaGenerator.__super__.constructor.apply(this, arguments);
  }

  SqliteSchemaGenerator.prototype.typeForColumn = function(column) {
  ...
  SqliteSchemaGenerator.prototype.transformToText = function(columnName) {
...
},{"./schema-generator-base":4,"underscore":10}],8:[function(require,module,exports){
var Column, Table;
...
var Schema, SchemaDiff, SqliteSchemaGenerator, instance;
...
instance.compareForms = function() {
  var diff, generator, newSchema, oldSchema, schemaDiff;
  if (instance.oldForm) {
  ...
  generator = new SqliteSchemaGenerator(diff);
...
},{"./lib/schema":6,"./lib/schema-diff":3,"./lib/sqlite-schema-generator":7}]},{},[11]);
