...
declare namespace Schema {
    ...
    namespace systemFormViewColumns {
        ...
        const system_status: string;
        const gps_device_capture: string;
    }
    ...
    namespace organizationViews {
        ...
        namespace signatures {
            const access_key_3: string;
            export { access_key_3 as access_key };
            const file_size_3: string;
            export { file_size_3 as file_size };
            const record_resource_id_6: string;
            export { record_resource_id_6 as record_resource_id };
            ...
            const content_type_3: string;
            export { content_type_3 as content_type };
            const uploaded_at_3: string;
            export { uploaded_at_3 as uploaded_at };
            const stored_at_3: string;
            export { stored_at_3 as stored_at };
            const processed_at_3: string;
            export { processed_at_3 as processed_at };
            const deleted_at_3: string;
            export { deleted_at_3 as deleted_at };
        }
        namespace record_series {
            ...
            const form_resource_id_5: string;
            export { form_resource_id_5 as form_resource_id };
            ...
            const created_by_resource_id_12: string;
            export { created_by_resource_id_12 as created_by_resource_id };
            const updated_by_resource_id_11: string;
            export { updated_by_resource_id_11 as updated_by_resource_id };
            const created_at_13: string;
            export { created_at_13 as created_at };
            const updated_at_13: string;
            export { updated_at_13 as updated_at };
        }
    }
