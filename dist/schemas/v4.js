...
Schema.systemFormFullViewColumns = (0, lodash_1.clone)(Schema.systemFormViewColumns);
...
Schema.systemRepeatableFullViewColumns = (0, lodash_1.clone)(Schema.systemRepeatableViewColumns);
...
Schema.systemFormTableIndexes = [
    ...
    { columns: ['record_key'], method: 'btree' },
    ...
    { columns: ['record_series_resource_id'], method: 'btree', predicate: 'record_series_resource_id IS NOT NULL' }
];
