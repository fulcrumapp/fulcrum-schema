...
SELECT
  ...
  "track" AS "track",
  "geometry" AS "geometry" FROM "audio";
...
SELECT
  ...
  "number_of_deletes" AS "number_of_deletes" FROM "changesets";
...
SELECT
  ...
  "updated_by_resource_id" AS "_updated_by_id",
  "created_at" AS "created_at",
  "updated_at" AS "updated_at" FROM "choice_lists";
...
SELECT
  ...
  "updated_by_resource_id" AS "_updated_by_id",
  "created_at" AS "created_at",
  "updated_at" AS "updated_at" FROM "classification_sets";
...
SELECT
  ...
  "status" AS "status",
  "created_at" AS "created_at",
  "updated_at" AS "updated_at" FROM "memberships";
...
SELECT
  ...
  "created_by_resource_id" AS "_created_by_id",
  "created_at" AS "created_at",
  "updated_at" AS "updated_at" FROM "projects";
...
SELECT
  ...
  "can_run_reports" AS "can_run_reports" FROM "roles";
...
SELECT
  ...
  "uploaded_at" AS "uploaded_at",
  "stored_at" AS "stored_at",
  "processed_at" AS "processed_at" FROM "signatures";
...
SELECT
  ...
  "has_track" AS "has_track",
  "track" AS "track",
  "geometry" AS "geometry" FROM "videos";
