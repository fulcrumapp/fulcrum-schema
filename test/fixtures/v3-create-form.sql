...
INSERT INTO "organization_1"."columns" (table_name, table_alias, name, ordinal, type, nullable, form_id, field, field_type, data_name, part, data)
SELECT 'form_67777_view', 'Park Inventory Test', 'button_label', '77', 'string', '1', 'd3720dff-de27-4e79-a4ec-9dddb6553a45', 'bgd4', 'ButtonField', 'button', 'label', NULL;
INSERT INTO "organization_1"."columns" (table_name, table_alias, name, ordinal, type, nullable, form_id, field, field_type, data_name, part, data)
SELECT 'form_67777_view', 'Park Inventory Test', 'button_type', '78', 'string', '1', 'd3720dff-de27-4e79-a4ec-9dddb6553a45', 'bgd4', 'ButtonField', 'button', 'type', NULL;
